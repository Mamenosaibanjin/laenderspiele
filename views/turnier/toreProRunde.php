...
$this->title = "Tore pro Runde - $turniername";
    ...
    <div class="col-md-7">
        <div class="card">
            <div class="card-header">
                <h3>
                    <?= Html::encode("$turniername - Tore pro Runde") ?>
                </h3>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($statistikTore as $t): ?>
                            <tr>
                            	<td><b><?= $counter; ?></b></td>
                                <td>
                                    <?= Html::a(Helper::getTurniernameFullnameForDropdown($t['tournamentID']) . ' | ' . Helper::getRundename($t['rundeID']), ['/turnier/' . $t['tournamentID'] . '/ergebnisse/' . $t['rundeID']], ['class' => 'text-decoration-none']) ?>
                                </td>
                                <td><?= $t['tore'] ?></td>
                                <td><?= $t['spiele'] ?></td>
